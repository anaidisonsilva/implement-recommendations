...
const PrefeituraProgramas = () => {
  ...
  const { data: emendas, isLoading: loadingEmendas } = useQuery({
    queryKey: ['emendas', 'prefeitura', prefeitura?.id, 'programas'],
    queryFn: async () => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Portal de Transparência • Programas
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <PublicExportDialog
                ...
                title="Exportar Relatório de Programas"
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <PortalBreadcrumb slug={slug!} items={[{ label: 'Programas' }]} />
        <LastUpdatedBanner
          emendas={emendas}
        ...
        <div className="mb-6 grid gap-4 grid-cols-2 lg:grid-cols-5">
          <div className="rounded-xl border border-border bg-card p-4">
            <div className="flex items-center justify-between">
              <p className="text-xs font-medium text-muted-foreground">Total de Programas</p>
        ...
        <p className="mb-4 text-sm text-muted-foreground">
          {filteredEmendas.length} programa(s) encontrado(s)
          ...
          <>
            <div className="rounded-xl border border-border bg-card">
              <Table>
                <TableHeader>
                  <TableRow>
                     <TableHead>Nº Programa</TableHead>
          ...
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border py-16">
            ...
            <p className="mt-1 text-sm text-muted-foreground text-center max-w-lg">
                ...
                : (() => {
                    ...
                    return `Não foram recebidos programas no período de 01/01/${ano} até ${dataFim}.`;
                  })()}
            </p>
          </div>
        )}
...
export default PrefeituraProgramas;
